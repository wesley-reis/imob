<template>
  <h1 class="text-3xl text-gray-300 mt-3 mb-8 font-bold font-OpenSans">
    Login
  </h1>
  ...
  <div class="w-9/12">
    ...
    <div class="text-gray-300 text-center mt-9 text-xs">
      ...
      <a
        ...
        target="_black"
        class="text-green-500 mt-4 flex justify-center items-center gap-1"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
...
export default {
  ...
  methods: {
    showAlert() {
      window.Toast.fire({
        text: "Ooops, Hove algun problema",
        icon: "info",
        background: "#E3E7F2",
      });
    },
